...
from uipath.core.otel.attributes import Attr
from uipath.core.otel.integrations._shared import InstrumentationConfig
from uipath.core.otel.integrations.langchain._extractors import (
...
class TestExtractLLMAttributes:
    ...
    def test_extract_gen_ai_attributes(self) -> None:
        """Test extraction of OTel GenAI semantic convention attributes."""
        run = Mock()
        run.extra = {
            "invocation_params": {
                "model_name": "gpt-4",
    ...
    def test_extract_input_output_values(self) -> None:
        ...
        # OTel GenAI prompt and completion
