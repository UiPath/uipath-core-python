...
from uipath.core.otel.integrations._shared import set_session_context
from uipath.core.otel.integrations.langgraph._callbacks import LangGraphTracer
...
@pytest.fixture
def tracer(otel_client: TelemetryClient) -> LangGraphTracer:
...
def setup_session_context():
    ...
    yield
    # Cleanup
    from uipath.core.otel.integrations._shared import clear_session_context
...
def test_langgraph_metadata_uses_native_types_not_json_strings(
    ...
    # OTel may convert lists to tuples - both are acceptable
