...
conventions used in the otel/ module. Attributes are organized by domain for
...
Usage:
    from uipath.core.otel.attributes import Attr, SpanKind
...
class Attr:
    ...
    class Internal:
        ...
        PARSING_ERROR = "otel.parsing_error"
        PARSING_ERROR_TYPE = "otel.parsing_error_type"
