...
from .._thread_safe import DictWithLock
...
class LangGraphTracer(BaseCallbackHandler):
    ...
    def __init__(
        ...
        # CRITICAL FIX: Use thread-safe run_id → span mapping instead of stack
        self._spans: DictWithLock[UUID, Span] = DictWithLock()
        ...
        if self.trace_state:
            ...
            try:
                ...
                if filtered_state is not None:
                    span.set_attribute(Attr.Common.INPUT_VALUE, json.dumps(filtered_state))
        ...
        **kwargs: Any,
        ...
        if self.trace_state:
            try:
                ...
                if filtered_state is not None:
                    span.set_attribute(Attr.Common.OUTPUT_VALUE, json.dumps(filtered_state))
