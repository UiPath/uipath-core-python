...
class UiPathInstrumentor(BaseInstrumentor):
    ...
    Provides access to UiPath OTel client and shared utilities.
    ...
    def __init__(self) -> None:
        ...
        super().__init__()
        self._otel_client: TelemetryClient | None = None

    def _get_otel_client(self) -> TelemetryClient:
        """Get UiPath OTel client.
