...
def extract_llm_attributes(run: Run, config: InstrumentationConfig) -> dict[str, Any]:
    ...
    if run.outputs and config.capture_outputs:
        ...
        if llm_output:
            ...
            # Telemetry GenAI response model (may differ from request)
